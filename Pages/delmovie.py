...
w = None
def create_DelMovie(rt, *args, **kwargs):
    '''Starting point when module is imported by another module.
       Correct form of call: 'create_DelMovie(root, *args, **kwargs)' .'''
    global w, w_win, root
    #rt = root
    root = rt
    w = tk.Toplevel (root)
...
class DelMovie:
    def __init__(self, top=None):
        ...
        self.delmovie_b = tk.Button(top)
        self.delmovie_b.place(relx=0.594, rely=0.7, height=84, width=207)
        ...
        self.delmovie_b.configure(highlightbackground="#d9d9d9")
        self.delmovie_b.configure(highlightcolor="black")
        self.delmovie_b.configure(pady="0")
        self.delmovie_b.configure(text='''Delete Movie''')
