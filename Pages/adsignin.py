...
#########################################################
'''Query that executes the query string given'''
#########################################################
...
#########################################################
'''Performs Select username query'''
#########################################################    
def login(ema,passw):
    df = query('select username from admin where email="{0}" and pass="{1}"'.format(ema,passw))
    if(df.empty):
        return 0
    else:
...
def cal(root,em,pas):
    ...
    if len(ema)==0 or len(passw)==0:
        ...
        print(ema,passw)
        name=login(ema,passw)
        print(name)
        if name!=0:
            root.destroy()
            print(f'from sign in {name}')
            vp_start_guih()
        else:
...
class Signin:
    ...
    def __init__(self, top=None):
        ...
        self.Label4.place(relx=0.31, rely=0.25, height=21, width=174)
        ...
        self.Label4.configure(text='''Admin Login!''')

        
        em=tk.StringVar()
        self.email_e = tk.Entry(top,textvariable=em)
        self.email_e.place(relx=0.234, rely=0.555, height=30, relwidth=0.548)
        ...
        self.email_l.place(relx=0.211, rely=0.51, height=21, width=124)
        ...
        self.password_e.place(relx=0.234, rely=0.717, height=30, relwidth=0.548)
        ...
        self.password_l.place(relx=0.211, rely=0.673, height=21, width=98)
        ...
        self.Submit.place(relx=0.300, rely=0.8, height=44, width=177)
