...
#  Mar 24, 2021 11:55:07 AM IST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    label $site_3_0.lab57 \
        ...
        -foreground #ffffff \
        -text {It seems that you are under 18 and trying to book a ticket for an adult movie. Sending you to Home page} \
        -wraplength 600 
    ...
    vTcl:DefineAlias "$site_3_0.but59" "Continue_b" vTcl:WidgetProc "Search" 1
    place $site_3_0.lab50 \
        -in $site_3_0 -x 0 -relx 0.39 -y 0 -rely 0.165 -width 0 \
        -relwidth 0.205 -height 0 -relheight 0.193 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab57 \
        -in $site_3_0 -x 0 -relx 0.126 -y 0 -rely 0.4 -width 0 \
