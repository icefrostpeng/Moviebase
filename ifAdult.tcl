...
#  Mar 24, 2021 11:04:02 AM IST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    label $site_3_0.lab57 \
        ...
        -font {-family {Segoe UI} -size 17 -weight normal -slant roman -underline 0 -overstrike 0} \
        -foreground #ffffff \
        -text {Else You may not be allowed entry and may result is cancellation of ticket at the Cinema. Theatre Buzz will not be held resposible in any way for cancellation of such tickets.} \
        -wraplength 600 
    vTcl:DefineAlias "$site_3_0.lab57" "Label2" vTcl:WidgetProc "Search" 1
    checkbutton $site_3_0.che58 \
        ...
        -text {I agree that we all are Adults} -variable che58 
    vTcl:DefineAlias "$site_3_0.che58" "Checkbutton1" vTcl:WidgetProc "Search" 1
    button $site_3_0.but59 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Continue 
    vTcl:DefineAlias "$site_3_0.but59" "Button1" vTcl:WidgetProc "Search" 1
    place $site_3_0.lab50 \
        -in $site_3_0 -x 0 -relx 0.126 -y 0 -rely 0.141 -width 0 \
        -relwidth 0.848 -height 0 -relheight 0.334 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab57 \
        -in $site_3_0 -x 0 -relx 0.126 -y 0 -rely 0.424 -width 0 \
        -relwidth 0.746 -height 0 -relheight 0.285 -anchor nw \
        -bordermode ignore 
    place $site_3_0.che58 \
        -in $site_3_0 -x 0 -relx 0.05 -y 0 -rely 0.824 -width 0 \
        -relwidth 0.366 -height 0 -relheight 0.106 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but59 \
        -in $site_3_0 -x 0 -relx 0.616 -y 0 -rely 0.847 -width 227 \
